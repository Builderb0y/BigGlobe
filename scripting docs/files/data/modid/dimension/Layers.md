Layers are responsible for filling a column with blocks. They are the first step in block placement. Both layer types (simple_2d and simple_3d) have the following properties:
