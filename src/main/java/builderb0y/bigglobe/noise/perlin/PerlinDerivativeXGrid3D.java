...
public class PerlinDerivativeXGrid3D extends PerlinBaseGrid3D {

	public PerlinDerivativeXGrid3D(Seed salt, int scaleX, int scaleY, int scaleZ, double max_slope, double max_offset) {
	...
	public double getValue(long seed, int x, int y, int z) {
		...
		return Interpolator.dMixPerlin(
			...
			Interpolator.mixLinear(
				Interpolator.mixLinear(slopeX000, slopeX001, smoothZ),
				Interpolator.mixLinear(slopeX010, slopeX011, smoothZ),
				smoothY
			),
			Interpolator.mixLinear(
				Interpolator.mixLinear(slopeX100, slopeX101, smoothZ),
				Interpolator.mixLinear(slopeX110, slopeX111, smoothZ),
				smoothY
			),
			fracX0
		) * this.rcpX;
