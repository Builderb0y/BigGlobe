...
public class CubicDerivativeXResampleGrid3D extends Resample64Grid3D {

	public CubicDerivativeXResampleGrid3D(Grid3D source, int scaleX, int scaleY, int scaleZ) {
