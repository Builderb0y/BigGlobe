...
public class CubicDerivativeZResampleGrid3D extends Resample64Grid3D {

	public CubicDerivativeZResampleGrid3D(Grid3D source, int scaleX, int scaleY, int scaleZ) {
