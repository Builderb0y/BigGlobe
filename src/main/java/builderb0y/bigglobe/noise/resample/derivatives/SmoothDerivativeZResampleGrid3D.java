...
public class SmoothDerivativeZResampleGrid3D extends Resample8Grid3D {

	public SmoothDerivativeZResampleGrid3D(Grid3D source, int scaleX, int scaleY, int scaleZ) {
