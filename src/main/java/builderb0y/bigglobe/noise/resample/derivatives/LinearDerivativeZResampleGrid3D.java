...
public class LinearDerivativeZResampleGrid3D extends Resample8Grid3D {

	public LinearDerivativeZResampleGrid3D(Grid3D source, int scaleX, int scaleY, int scaleZ) {
