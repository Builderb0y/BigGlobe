...
public interface Grid3D extends Grid, CoderRegistryTyped<Grid3D> {
	...
	public static final Object INITIALIZER = new Object() {{
		if (REGISTRY != null) {
			...
			REGISTRY.registerAuto(BigGlobeMod.modID("dx_linear_resample"),     DxLinearResampleGrid3D.class);
			REGISTRY.registerAuto(BigGlobeMod.modID("dx_smooth_resample"),     DxSmoothResampleGrid3D.class);
			REGISTRY.registerAuto(BigGlobeMod.modID("dx_smoother_resample"), DxSmootherResampleGrid3D.class);
			REGISTRY.registerAuto(BigGlobeMod.modID("dx_cubic_resample"),       DxCubicResampleGrid3D.class);

			REGISTRY.registerAuto(BigGlobeMod.modID("dy_linear_resample"),     DyLinearResampleGrid3D.class);
			REGISTRY.registerAuto(BigGlobeMod.modID("dy_smooth_resample"),     DySmoothResampleGrid3D.class);
			REGISTRY.registerAuto(BigGlobeMod.modID("dy_smoother_resample"), DySmootherResampleGrid3D.class);
			REGISTRY.registerAuto(BigGlobeMod.modID("dy_cubic_resample"),       DyCubicResampleGrid3D.class);

			REGISTRY.registerAuto(BigGlobeMod.modID("dz_linear_resample"),     DzLinearResampleGrid3D.class);
			REGISTRY.registerAuto(BigGlobeMod.modID("dz_smooth_resample"),     DzSmoothResampleGrid3D.class);
			REGISTRY.registerAuto(BigGlobeMod.modID("dz_smoother_resample"), DzSmootherResampleGrid3D.class);
			REGISTRY.registerAuto(BigGlobeMod.modID("dz_cubic_resample"),       DzCubicResampleGrid3D.class);
