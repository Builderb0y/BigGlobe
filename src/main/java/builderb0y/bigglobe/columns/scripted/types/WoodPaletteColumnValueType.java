...
public class WoodPaletteColumnValueType extends AbstractColumnValueType {
	...
	public InsnTree createConstant(Object object, ColumnCompileContext context) {
		...
		context.registry.registries.getRegistry(BigGlobeDynamicRegistries.WOOD_PALETTE_REGISTRY_KEY).getOrCreateEntry(RegistryKey.of(BigGlobeDynamicRegistries.WOOD_PALETTE_REGISTRY_KEY, new Identifier(string)));
