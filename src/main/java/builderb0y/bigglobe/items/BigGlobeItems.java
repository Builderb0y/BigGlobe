...
public class BigGlobeItems {
	...
	public static final BlockItem
		...
		ROCK                     = register("rock", new RockItem(BigGlobeBlocks.ROCK, settings(ItemGroup.MISC))),
		...
		CHARRED_SIGN             = register("charred_sign", new ColoredSignItem(settings(ItemGroup.DECORATIONS).maxCount(16), BigGlobeBlocks.CHARRED_SIGN, BigGlobeBlocks.CHARRED_WALL_SIGN, DyeColor.LIGHT_GRAY)),
		...
		CHARRED_DOOR             = register("charred_door", new TallBlockItem(BigGlobeBlocks.CHARRED_DOOR, settings(ItemGroup.REDSTONE))),
	...
	public static final Item ASH = register("ash", new Item(settings(ItemGroup.BREWING)));
	public static final Item SULFUR = register("sulfur", new Item(settings(ItemGroup.MISC)));
	public static final BucketItem SOUL_LAVA_BUCKET = register(
		"soul_lava_bucket",
		new BucketItem(
			BigGlobeFluids.SOUL_LAVA,
			settings(ItemGroup.MISC).recipeRemainder(Items.BUCKET).maxCount(1)
		)
	);
	public static final Item CHORUS_SPORE = register("chorus_spore", new Item(settings(ItemGroup.BREWING)));
