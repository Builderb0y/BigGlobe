...
public class OverworldCavernSettings {
	...
	public final RegistryWrapper<LocalCavernSettings> template_registry;
	public final IRandomList<LocalCavernSettings> templates;

	public OverworldCavernSettings(VoronoiDiagram2D placement, RegistryWrapper<LocalCavernSettings> template_registry) {
