...
public class BigGlobeDynamicRegistries {
	...
	public static final List<DynamicRegistryManager.Info<?>> INFOS = new ArrayList<>(8);
	static {
		INFOS.add(info(SCRIPT_TEMPLATE_REGISTRY_KEY,                 ScriptTemplate                 .class));
		INFOS.add(info(SCRIPT_STRUCTURE_PLACEMENT_REGISTRY_KEY,      StructurePlacementScript.Holder.class));
		INFOS.add(info(WOOD_PALETTE_REGISTRY_KEY,                    WoodPalette                    .class));
		INFOS.add(info(OVERWORLD_BIOME_LAYOUT_REGISTRY_KEY,          OverworldBiomeLayout           .class));
		INFOS.add(info(LOCAL_OVERWORLD_CAVE_SETTINGS_REGISTRY_KEY,   LocalOverworldCaveSettings     .class));
		INFOS.add(info(LOCAL_OVERWORLD_CAVERN_SETTINGS_REGISTRY_KEY, LocalCavernSettings            .class));
		INFOS.add(info(LOCAL_SKYLAND_SETTINGS_REGISTRY_KEY,          LocalSkylandSettings           .class));
		INFOS.add(info(LOCAL_NETHER_SETTINGS_REGISTRY_KEY,           LocalNetherSettings            .class));
	}
