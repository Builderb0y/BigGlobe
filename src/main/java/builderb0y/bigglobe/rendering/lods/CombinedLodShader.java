...
public class CombinedLodShader extends VanillaLodShader {

	public int transformations;

	public CombinedLodShader() {
		this.compileStage(
			this.fragmentStage,
			//language=glsl
			"""
		...
		this.compileStage(
			...
			uniform samplerBuffer transformations;
		...
		this.transformations = glGetUniformLocation(this.program, "transformations");
	...
	public void bindTextures() {
		super.bindTextures();
		glUniform1i(this.transformations, 1);
	}
}