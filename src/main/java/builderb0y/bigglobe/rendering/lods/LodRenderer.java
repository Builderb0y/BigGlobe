...
public interface LodRenderer extends SafeCloseable {
	...
	*/
	...
	/**
	returns a NEW VersionedVertexConsumerProvider that
	...
	*/
	public abstract VersionedVertexConsumerProvider beginMeshing();

	/**
	called when new meshes have been finished.
	the provided MeshUploader will itself accept
	VersionedVertexConsumerProvider's which were previously
	...
	*/
	...
	public static interface MeshUploader extends SafeCloseable {
		...
		/**
		@param provider a VersionedVertexConsumerProvider which was
		...
		*/
		public SafeCloseable upload(VersionedVertexConsumerProvider provider) throws OutOfVramException;
	}
