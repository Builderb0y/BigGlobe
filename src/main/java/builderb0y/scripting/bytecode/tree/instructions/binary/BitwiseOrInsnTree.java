...
public class BitwiseOrInsnTree extends BinaryInsnTree {
	...
	public static TypeInfo validate(TypeInfo left, TypeInfo right) {
		...
		throw new InvalidOperandException("Cannot bitwise or " + left + " and " + right);
	}
	...
	public static InsnTree create(ExpressionParser parser, InsnTree left, InsnTree right) {
		...
		return new BitwiseOrInsnTree(left, right, type.getOpcode(IOR));
	}
}