...
import builderb0y.scripting.bytecode.tree.instructions.update.NullableReceiverListMapUpdaterInsnTree;
import builderb0y.scripting.parsing.ExpressionParser;
import builderb0y.scripting.parsing.ScriptParsingException;

public class NullableReceiverListMapGetterInsnTree extends BaseInvokeInsnTree {

	public MethodInfo replacer;
	public String type;

	public NullableReceiverListMapGetterInsnTree(
		InsnTree receiver,
		MethodInfo getter,
		InsnTree key,
		MethodInfo replacer,
