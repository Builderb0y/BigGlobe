...
public class BitwiseAndInsnTree extends BinaryInsnTree {
	...
	public BitwiseAndInsnTree(InsnTree left, InsnTree right, int opcode) {
	...
	public static TypeInfo validate(TypeInfo left, TypeInfo right) {
		...
		throw new InvalidOperandException("Cannot bitwise and " + left + " and " + right);
	}
	...
	public static InsnTree create(ExpressionParser parser, InsnTree left, InsnTree right) {
		...
		return new BitwiseAndInsnTree(left, right, type.getOpcode(IAND));
	}
}