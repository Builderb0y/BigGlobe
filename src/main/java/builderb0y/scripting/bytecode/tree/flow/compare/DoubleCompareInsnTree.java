...
public class DoubleCompareInsnTree extends FloatLikeCompareInsnTree {

	public DoubleCompareInsnTree(
		InsnTree left,
		InsnTree right,
		InsnTree lessThan,
		InsnTree equalTo,
	...
	public InsnTree doCast(ExpressionParser parser, TypeInfo type, CastMode mode) {
		...
		return new DoubleCompareInsnTree(this.left, this.right, lessThan, equalTo, greaterThan, this.incomparable, type);
	}
}