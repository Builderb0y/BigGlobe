...
public class IntCompareInsnTree extends IntLikeCompareInsnTree {

	public IntCompareInsnTree(
		InsnTree left,
		InsnTree right,
		InsnTree lessThan,
		InsnTree equalTo,
	...
	public void emitBytecode(MethodCompileContext method) {
		...
		method.node.visitJumpInsn(IF_ICMPGT, greaterThan.getLabel());
		method.node.visitJumpInsn(IF_ICMPLT, lessThan.getLabel());
	...
	public InsnTree doCast(ExpressionParser parser, TypeInfo type, CastMode mode) {
		...
		return new IntCompareInsnTree(this.left, this.right, lessThan, equalTo, greaterThan, type);
	}
}