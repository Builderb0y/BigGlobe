...
public class FastMathTest {
	...
	public void testHyperbolic() {
		checkProportional(-4.0D, 4.0D, 0.0625D, Math::sinh, FastMath.Trig::fastSinh, 0.001D);
		checkProportional(-4.0D, 4.0D, 0.0625D, Math::cosh, FastMath.Trig::fastCosh, 0.001D);
		checkRelative(-4.0D, 4.0D, 0.0625D, Math::tanh, FastMath.Trig::fastTanh, 0.001D);
	}

	@Test
	public void testInverseHyperbolic() {
		checkRelative(-10.0D, 10.0D, 0.0625D, MathScriptEnvironment::asinh, FastMath.Trig::fastAsinh, 0.001D);
		checkRelative(1.0D, 10.0D, 0.0625D, MathScriptEnvironment::acosh, FastMath.Trig::fastAcosh, 0.001D);
		checkRelative(-1.0D + 0.015625D, 1.0D - 0.015625D, 0.015625D, MathScriptEnvironment::atanh, FastMath.Trig::fastAtanh, 0.001D);
	}

	@Test
	public void testExp() {
		checkProportional(-4.0D, 4.0D, 0.0625D, Math::exp, FastMath.Exp::fastExp, 0.001D);
	}

	@Test
	public void testLog() {
		checkRelative(0.015625D, 10.0D, 0.015625D, Math::log, FastMath.Log::fastLog, 0.001D);
	}
