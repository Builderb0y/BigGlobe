...
public class QuinticDerivativeXResampleGrid3D extends Resample64Grid3D {

	public QuinticDerivativeXResampleGrid3D(Grid3D source, int scaleX, int scaleY, int scaleZ) {
