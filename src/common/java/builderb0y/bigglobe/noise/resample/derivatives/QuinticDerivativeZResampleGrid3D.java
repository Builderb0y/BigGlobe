...
public class QuinticDerivativeZResampleGrid3D extends Resample64Grid3D {

	public QuinticDerivativeZResampleGrid3D(Grid3D source, int scaleX, int scaleY, int scaleZ) {
