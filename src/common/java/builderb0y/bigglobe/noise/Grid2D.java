...
public interface Grid2D extends Grid, CoderRegistryTyped<Grid2D> {
	...
	public static final Object INITIALIZER = new Object() {{
		if (REGISTRY != null) {
			...
			REGISTRY.registerAuto(BigGlobeMod.modID("quintic"             ),                     QuinticGrid2D.class);
			...
			REGISTRY.registerAuto(BigGlobeMod.modID("quintic_resample"    ),             QuinticResampleGrid2D.class);
			...
			REGISTRY.registerAuto(BigGlobeMod.modID("dx_quintic_resample" ),  QuinticDerivativeXResampleGrid2D.class);
			...
			REGISTRY.registerAuto(BigGlobeMod.modID("dy_quintic_resample" ),  QuinticDerivativeYResampleGrid2D.class);
