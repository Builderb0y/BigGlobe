...
public class PerlinDerivativeZGrid3D extends PerlinBaseGrid3D {

	public PerlinDerivativeZGrid3D(Seed salt, int scaleX, int scaleY, int scaleZ, double max_slope, double max_offset) {
	...
	public double getValue(long seed, int x, int y, int z) {
		...
		return Interpolator.dMixPerlin(
			...
			Interpolator.mixLinear(
				Interpolator.mixLinear(slopeZ000, slopeZ010, smoothY),
				Interpolator.mixLinear(slopeZ100, slopeZ110, smoothY),
				smoothX
			),
			Interpolator.mixLinear(
				Interpolator.mixLinear(slopeZ001, slopeZ011, smoothY),
				Interpolator.mixLinear(slopeZ101, slopeZ111, smoothY),
				smoothX
			),
			fracZ0
		) * this.rcpZ;
	...
	public void getBulkX(long seed, int startX, int y, int z, NumberArray samples) {
		...
		double
			...
			dSmoothZ = Interpolator.smoothDerivative(fracZ0),
