...
public class BigGlobeBlockTags {
	...
	public static final TagKey<Block>
		...
		MIMIC_ORES_PREFER                   = of("mimic_ores_prefer"),
		MIMIC_ORES_IGNORE                   = of("mimic_ores_ignore"),
		//general
	...
	public static TagKey<Block> of(String name) {
		return TagKey.create(Registries.BLOCK, BigGlobeMod.modID(name));
	}

	public static TagKey<Block> common(String name) {
		return TagKey.create(Registries.BLOCK, IdentifierVersions.create("c", name));
	}
}