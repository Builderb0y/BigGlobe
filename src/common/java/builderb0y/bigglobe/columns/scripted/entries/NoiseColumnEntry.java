...
import builderb0y.bigglobe.columns.scripted2.types.DoubleColumnValueType;
import builderb0y.bigglobe.columns.scripted2.types.FloatColumnValueType;
		...
		computeAllMethod.setCode(
			...
			(MutableScriptEnvironment environment) -> {
				environment
					...
					.addFunction(
						"seed", new FunctionHandler.Named(
							"seed(long salt)", (ExpressionParser parser, String name, InsnTree... arguments) -> {
