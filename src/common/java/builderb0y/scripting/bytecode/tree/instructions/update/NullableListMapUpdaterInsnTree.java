...
public class NullableListMapUpdaterInsnTree extends ListMapUpdaterInsnTree {

	public NullableListMapUpdaterInsnTree(CombinedMode mode, InsnTree receiver, InsnTree key, InsnTree value, MethodInfo replacer) {
		super(mode, receiver, key, value, replacer);
	}

	public NullableListMapUpdaterInsnTree(UpdateOrder order, boolean isAssignment, InsnTree receiver, InsnTree key, InsnTree value, MethodInfo replacer) {
	...
	public InsnTree asStatement() {
		return this.mode.isVoid() ? this : new NullableListMapUpdaterInsnTree(this.mode.asVoid(), this.receiver, this.key, this.value, this.replacer);
	}
}