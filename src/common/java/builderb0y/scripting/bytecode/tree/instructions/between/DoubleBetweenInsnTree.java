...
public class DoubleBetweenInsnTree extends BetweenInsnTree {

	public DoubleBetweenInsnTree(
		InsnTree value,
		InsnTree min,
	...
	public static InsnTree create(
		...
		return new DoubleBetweenInsnTree(
			value.cast(parser, TypeInfos.DOUBLE, CastMode.IMPLICIT_THROW, false),
			min.cast(parser, TypeInfos.DOUBLE, CastMode.IMPLICIT_THROW, false),
			minInclusive,
			max.cast(parser, TypeInfos.DOUBLE, CastMode.IMPLICIT_THROW, false),
			maxInclusive
		);
	}
