...
public class BuiltinScriptEnvironment {
	...
	public static final MutableScriptEnvironment INSTANCE = (
		...
		*/
		...
		.addCast(TypeInfos.BYTE, TypeInfos.LONG,   true, CastingSupport.I2L.changeInput(TypeInfos.BYTE))
		.addCast(TypeInfos.BYTE, TypeInfos.FLOAT,  true, CastingSupport.I2F.changeInput(TypeInfos.BYTE))
		.addCast(TypeInfos.BYTE, TypeInfos.DOUBLE, true, CastingSupport.I2D.changeInput(TypeInfos.BYTE))
		//char
		//.addCast(TypeInfos.CHAR, TypeInfos.BOOLEAN, false, CastingSupport.I2Z)
		.addCast(TypeInfos.CHAR, TypeInfos.BYTE,   false, CastingSupport.I2B.changeInput(TypeInfos.CHAR))
		.addCast(TypeInfos.CHAR, TypeInfos.SHORT,  true,  CastingSupport.I2S.changeInput(TypeInfos.CHAR))
		.addCastIdentity(TypeInfos.CHAR, TypeInfos.INT, true)
		.addCast(TypeInfos.CHAR, TypeInfos.LONG,   true,  CastingSupport.I2L.changeInput(TypeInfos.CHAR))
		.addCast(TypeInfos.CHAR, TypeInfos.FLOAT,  true,  CastingSupport.I2F.changeInput(TypeInfos.CHAR))
		.addCast(TypeInfos.CHAR, TypeInfos.DOUBLE, true,  CastingSupport.I2D.changeInput(TypeInfos.CHAR))
		//short
		//.addCast(TypeInfos.SHORT, TypeInfos.BOOLEAN, false, CastingSupport.I2Z)
		.addCast(TypeInfos.SHORT, TypeInfos.BYTE,   false, CastingSupport.I2B.changeInput(TypeInfos.SHORT))
		.addCast(TypeInfos.SHORT, TypeInfos.CHAR,   false, CastingSupport.I2C.changeInput(TypeInfos.SHORT))
		.addCastIdentity(TypeInfos.SHORT, TypeInfos.INT, true)
		.addCast(TypeInfos.SHORT, TypeInfos.LONG,   true,  CastingSupport.I2L.changeInput(TypeInfos.SHORT))
		.addCast(TypeInfos.SHORT, TypeInfos.FLOAT,  true,  CastingSupport.I2F.changeInput(TypeInfos.SHORT))
		.addCast(TypeInfos.SHORT, TypeInfos.DOUBLE, true,  CastingSupport.I2D.changeInput(TypeInfos.SHORT))
		//int
